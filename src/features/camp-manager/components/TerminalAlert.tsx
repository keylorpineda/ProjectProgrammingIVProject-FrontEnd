    ...
    <div className={`p-4 font-mono select-none ${activeTheme.border} ${activeTheme.bg}`}>
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className={`px-1.5 py-0.5 text-xs font-bold uppercase tracking-wider ${activeTheme.tag}`}>
            {title}
          </span>
        </div>
        {onClose && (
      ...
      <div className="mt-1 text-[10px] text-zinc-500 flex justify-between uppercase">
