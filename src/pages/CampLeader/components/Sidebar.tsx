  ...
  return (
    ...
    >
      ...
      <div className="mb-6 px-4 text-center hidden md:block shrink-0">
        <h2 className="font-typewriter text-xl tracking-wider font-bold flex items-center justify-center gap-2" style={{ color: '#fca311' }}>
          <Skull className="w-5 h-5 text-red-500 animate-pulse" />
          DOOMSDAY
        </h2>
        <span className="text-[10px] font-mono opacity-80 block tracking-widest uppercase mt-1" style={{ color: '#fca311' }}>
          REGISTRO DE REFUGIO
        </span>
      </div>
      ...
      <div className="mt-auto px-4 w-full hidden md:block shrink-0">
        ...
        >
          ...
          <p className="text-[10px] font-mono leading-5 mt-1 font-extrabold animate-pulse" style={{ color: '#ef4444' }}>
            SITUACIÓN: COMBATE
          </p>
        </div>
      </div>
