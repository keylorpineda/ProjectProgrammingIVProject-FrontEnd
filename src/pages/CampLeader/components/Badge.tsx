...
export const ACHIEVEMENTS_DICT: Record<string, AchievementDetails> = {
  VETERANO_PARAMO: {
    ...
    icon: "\uD83C\uDF96\uFE0F",
    description: "Sobreviviente de alto rango curtido en la exploracion de zonas contaminadas y escombros radiactivos.",
  ...
  SOBREVIVIENTE_ELITE: {
    ...
    icon: "\uD83C\uDFC6",
    description: "Capitan experto de bunker con mas de 10 expediciones de combate exitosas reportadas.",
  ...
  PRIMEROS_AUXILIOS_AVANZADOS: {
    ...
    icon: "\uD83D\uDC89",
    description: "Medico de campo calificado para neutralizacion inmediata de toxinas mutantes y suturas rapidas.",
