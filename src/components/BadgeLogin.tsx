...
export function BadgeLogin({ onLogin, isProcessing, loginStatus }: BadgeLoginProps) {
  ...
  const currentVariant = loginStatus === "granted" ? "granted" : 
                         loginStatus === "processing" ? "processing" :
    ...
    >
      ...
      <div style={{ filter: "drop-shadow(0 20px 25px rgba(0,0,0,0.8)) drop-shadow(0 5px 10px rgba(0,0,0,0.5))", width: "100%" }}>
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none z-10 rounded-xl border border-white/40" style={{
        ...
        <div className="flex-1 w-full flex flex-col p-4 sm:p-6 relative z-20" style={{ marginTop: "3.5rem" }}>
          ...
          <div className="border-b-[4px] border-[#3a3528] pb-3 mb-10 flex justify-between items-start gap-2" style={{ width: "80%", margin: "0 auto" }}>
             <div className="flex flex-col relative w-full pt-1">
               <h2 className="font-sans font-black text-[20px] sm:text-[22px] tracking-tighter leading-none uppercase" style={{ color: "#3a3528" }}>INICIO DE SESIÓN</h2>
               <p className="text-[10px] tracking-widest font-bold uppercase mt-1" style={{ color: "#3a3528" }}>Acceso Autorizado</p>
             </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex-1 flex flex-col gap-6 w-full" style={{ marginTop: "30px" }}>
            ...
            >
               ...
               <div className="flex-1 flex flex-col gap-3">
                 <motion.div className="flex flex-col gap-1.5 relative" animate={(shake && !username) || loginStatus === "denied" ? { x: [-8, 8, -6, 6, -4, 4, 0], transition: { duration: 0.4 } } : {}}>
                 ...
                 <motion.div className="flex flex-col gap-1.5 relative" animate={(shake && !password) || loginStatus === "denied" ? { x: [-8, 8, -6, 6, -4, 4, 0], transition: { duration: 0.4 } } : {}}>
                   <label className="text-[12px] font-black font-sans text-[#1a1a1a] tracking-[0.2em] uppercase flex items-center gap-2">
                     CONTRASEÑA
                   </label>
                     ...
                     >
                        ...
                        <motion.div 
                          ...
                          animate={{
                             ...
                             boxShadow: showPassword ? "inset 0 0 8px rgba(245,158,11,0.8), 0 0 6px rgba(245,158,11,0.6)" : "inset 0 0 5px rgba(0,0,0,1), 0 0 0 rgba(0,0,0,0)"
                          }}
                        >
                           <motion.div
                           ...
                           >
                              <motion.div
                                ...
                                animate={{ scale: showPassword ? 1 : 0.1, opacity: showPassword ? 1 : 0 }}
                              />
                           </motion.div>
                        </motion.div>
                     </button>
            ...
            <div className="w-[80%] flex justify-between mb-2 items-center gap-4" style={{ margin: "0 auto", marginTop: "3rem" }}>
               ...
               <div className="w-12 h-12 rounded-full border border-yellow-500/30 flex items-center justify-center bg-gradient-to-tr from-yellow-100 via-yellow-400 to-amber-600 opacity-80 mix-blend-multiply shadow-[inset_0_0_15px_rgba(0,0,0,0.6)] relative overflow-hidden shrink-0">
                  <span className="text-[10px] font-black text-black/40 rotate-45 tracking-widest drop-shadow-md">VALID</span>
            ...
            <div className="flex flex-col gap-4 mt-4 mb-2 w-[80%]" style={{ margin: "0 auto" }}>
              <button 
                ...
                onMouseEnter={e => {
                  ...
                  (e.currentTarget as HTMLButtonElement).style.boxShadow = "inset 0 0 0 2px #f59e0b, 0 4px 0 #0a0a0a, 0 0 20px rgba(245,158,11,0.4), 0 5px 5px rgba(0,0,0,0.5)";
              ...
              >
                ...
                <span className="relative z-10 group-active:text-amber-300 transition-colors">{isProcessing ? "PROCESANDO..." : "INICIAR SESIÓN"}</span>
              </button>
